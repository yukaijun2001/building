...
class TimesMIMO(nn.Module):
    def __init__(self, configs):
        ...
        self.time_future = configs.pred_len // self.token_len
        ...
        self.input_encoder = nn.Linear(self.hidden_dim_of_llama * 2, self.hidden_dim_of_llama)
        self.moe = MoE(self.hidden_dim_of_llama, self.hidden_dim_of_llama)
        self.decoder = MLP(self.hidden_dim_of_llama, self.token_len * self.time_future,
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        dec_out = dec_out.reshape(bs, 1, -1)
