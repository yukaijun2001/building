def print_args(args):
    ...
    if args.model == 'PatchGatedLSTM':
        print("\033[1m" + "PatchGatedLSTM Parameters" + "\033[0m")
        print(f'  {"Patch Len:":<20}{args.patch_len:<20}{"Patch Stride:":<20}{args.patch_stride:<20}')
        print(f'  {"Top K Patches:":<20}{args.top_k_patches:<20}{"Hidden Size:":<20}{args.hidden_size:<20}')
        print(f'  {"Model Dim:":<20}{args.model_dim:<20}{"LSTM Layers:":<20}{args.lstm_layers:<20}')
        print(f'  {"FFT Keep Ratio:":<20}{args.fft_keep_ratio:<20}')
        print()
